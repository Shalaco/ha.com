...
Transitional and XHTML 1.0 Strict DOCTYPEs. SlideDeck is distributed with a 
minified version of jQuery 1.7.1, or you can get the latest version from the 
jQuery website. Make sure your website is capable of using jQuery and one of
the XHTML DOCTYPEs before implementing SlideDeck.
...
An example of the callback feature to run JavaScript after a slide finished animating

example-callbacks-and-autoplay.html
An example of the callback and auto-play features working together
...
jquery-1.7.1.min.js
The jQuery 1.7.1 JavaScript library. This is provided for the purpose of the
